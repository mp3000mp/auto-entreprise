...
final class Version20231019003119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cost_type ADD label VARCHAR(55) NOT NULL, DROP trad, CHANGE position position INT NOT NULL');
        $this->addSql('ALTER TABLE mean_of_payment ADD label VARCHAR(55) NOT NULL, DROP trad, CHANGE position position INT NOT NULL');
